...
namespace UtilityClass
{
    ...
    public partial class NavBar : UserControl
    {
        ...
        public NavBar()
        {
            ButtonGroup temp = new ButtonGroup("欢迎使用");
            temp.ImageButtons.Add(new ImageButton("欢迎使用", "Main", UtilityClass.Properties .Resources.NavBtn1));
            NavButtonGroup.Add(temp);

            temp = new ButtonGroup("退出系统");
            NavButtonGroup.Add(temp);
            InitializeComponent();
        ...
        public class ButtonGroup : UserControl
        {
            ...
            private void InitializeControl()
            {
                ...
                TitleBar.BackgroundImage = UtilityClass.Properties.Resources.NavBarBG01;
            ...
            private void TitleBar_MouseLeave(object sender, EventArgs e)
            {
                if (sender is System.Windows.Forms.Label)
                {
                    ...
                    tmpLabel.BackgroundImage = UtilityClass.Properties.Resources.NavBarBG01;
                }
            }
            ...
            private void TitleBar_MouseMove(object sender, MouseEventArgs e)
            {
                ...
                {
                    System.Windows.Forms.Label tmpLabel = (System.Windows.Forms.Label)sender;
                    tmpLabel.BackgroundImage = UtilityClass.Properties.Resources.NavBarBG02;
                }
            }
        ...
        public class ImageButton : UserControl
        {
            ...
            private void ButtonImage_MouseMove(object sender, MouseEventArgs e)
            {
                ...
                {
                    PictureBox tmpPictureBox = (PictureBox)sender;
                    tmpPictureBox.BackgroundImage = UtilityClass.Properties.Resources.NavBtnBG;
                }
            }
